...
wt.tradePebble(wallet, peb2, 'ETH', 2); // trade 0.5 BTC on BTX to 1 ETH
...
wt.tradePebble(wallet, peb3, 'LTC', 3); // trade 1 BTC on binance to 3 LTC
...
wt.transferPebble(wallet, peb, 'binance', 0.1); // transfer 2 BTC on btx to 1.9 on binance
...
wt.transferPebble(wallet, peb2, 'binance', 0.2); // transfer 1 ETH on btx to 0.8 on binance
